...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-luxury focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 luxury-shadow",
        destructive:
        ...
        hero: "luxury-gradient text-white hover:opacity-90 luxury-shadow font-medium",
        elegant: "bg-elegant-gray text-white hover:bg-elegant-gray/90 elegant-shadow",
        luxury: "bg-luxury-gold text-white hover:bg-luxury-gold-dark luxury-shadow font-medium",
      },
      size: {
